...
# Imports organized in order to work both with Pygame and Pyjsdl
try:
	import pygame as pg
...
class TextWidget(Widget):
	...
	def __init__(self, parent, text, x=0, y=0, w=100, h=30, padding=4, font_size=16):
		super(TextWidget, self).__init__(parent, x, y, w, h, padding)
		self.text = text
...
class Button(TextWidget):
	...
	def __init__(
			self, parent, text, onclick, x=0, y=0, w=100, h=30, padding=4, font_size=16
	):
